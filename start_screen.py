...
class MainMenu:
    def __init__(self, win):
        ...
        self.logo = pygame.transform.scale(pygame.image.load(os.path.join("game assets", "logo.png")).convert_alpha(),
                                           (500, 500))
        self.logo_2 = pygame.transform.flip(pygame.transform.scale(
            pygame.image.load(os.path.join("game assets", "logo_2.png")).convert_alpha(), (475, 475)), True, False)
        ...
        self.win = win
        self.btn_start = (self.width/2 - self.empty_btn.get_width()/2, 200, self.empty_btn.get_width(),
    ...
    def draw(self):
        ...
        if self.btn_start[0] <= x <= self.btn_start[0] + self.btn_start[2] and \
                self.btn_start[1] <= y <= self.btn_start[1] + self.btn_start[3]:
